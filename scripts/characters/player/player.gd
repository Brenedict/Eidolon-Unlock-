...
@export_range(0, 300, 0.2, "or_greater") var walk_speed : float = 75.0
@export_range(0, 300, 0.2, "or_greater") var run_speed : float = 150.0
@export_range(0, 300, 0.2, "or_greater") var jump_force : float = 250.0
var run : bool = false
